...
use crate::{CandidateViewKind, LexiconEntry, MatchLevel, PolicyResult, RuleContext, TextDocument};
...
impl Detector {
    ...
    /// Creates a detector that runs rule and sparse channels without Lexicon.
    #[must_use]
    ...
    #[must_use]
    pub fn analyze_rules(&self, text: &str, context: RuleContext<'_>) -> PolicyResult {
        crate::policy::analyze_rules(self, text, context)
    }
