...
static ARTIFACTS: [EmbeddedArtifact; 15] = [
    ...
    EmbeddedArtifact::new(
        include_bytes!("../../../resources/models/multilingual-v2/es-sparse-v2.bin"),
...
pub const fn embedded_lexicon_bytes(language: Language) -> &'static [u8] {
    match language {
        Language::En => include_bytes!("../../../lexicon/EN.tsv"),
        Language::Zh => include_bytes!("../../../lexicon/ZH.tsv"),
        Language::Es => include_bytes!("../../../lexicon/ES.tsv"),
        Language::Ar => include_bytes!("../../../lexicon/AR.tsv"),
        Language::Ms => include_bytes!("../../../lexicon/ID.tsv"),
        Language::Pt => include_bytes!("../../../lexicon/PT.tsv"),
        Language::Fr => include_bytes!("../../../lexicon/FR.tsv"),
        Language::Hi => include_bytes!("../../../lexicon/HI.tsv"),
        Language::Ru => include_bytes!("../../../lexicon/RU.tsv"),
        Language::Ja => include_bytes!("../../../lexicon/JA.tsv"),
        Language::De => include_bytes!("../../../lexicon/DE.tsv"),
        Language::Tr => include_bytes!("../../../lexicon/TR.tsv"),
        Language::Vi => include_bytes!("../../../lexicon/VI.tsv"),
        Language::Ko => include_bytes!("../../../lexicon/KO.tsv"),
        Language::It => include_bytes!("../../../lexicon/IT.tsv"),
    }
}
