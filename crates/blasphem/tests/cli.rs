...
#[test]
fn check_rejects_a_missing_required_lexicon_file() {
...
#[test]
fn explicit_supported_language_uses_the_flat_lexicon_file() {
...
#[test]
#[cfg(feature = "language-detection")]
fn automatic_unknown_skips_lexicon_when_the_data_directory_is_missing() {
    let directory = tempdir().expect("temporary directory");
    let output = Command::new(env!("CARGO_BIN_EXE_blasphem"))
        .args([
            "check",
