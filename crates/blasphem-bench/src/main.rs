...
use serde::Serialize;
use toxbench::{AutoValidationConfig, collect_size_evidence, run_auto_validation, run_benchmark};

#[derive(Debug, Parser)]
#[command(name = "toxbench", about = "Experimental toxcheck runtime evidence")]
struct Cli {
    #[command(subcommand)]
