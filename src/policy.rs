...
use crate::sparse::embedded_model;
...
pub(crate) fn analyze(
    ...
    analyze_internal(detector, text, context, true)
}

pub(crate) fn analyze_without_sparse_with_pack(
    detector: &Detector,
    text: &str,
    reply_target: ReplyTarget,
    pack: &RulePack,
) -> PolicyResult {
    analyze_internal_with_pack(
        detector,
        text,
        AnalysisContext {
...
fn analyze_internal(
    ...
    analyze_internal_with_pack(detector, text, context, include_sparse, pack.as_ref())
}

fn analyze_internal_with_pack(
    detector: &Detector,
    text: &str,
    context: AnalysisContext<'_>,
    include_sparse: bool,
