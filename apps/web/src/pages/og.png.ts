...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  ...
  <text x="600" y="455" text-anchor="middle" font-family="Pirata One" font-size="48" fill="#ece7de">catch harm before send</text>
  <text x="600" y="560" text-anchor="middle" font-family="Pirata One" font-size="24" fill="#b3a695">web, mobile, servers · ${LANGUAGES.length} languages · runs locally</text>
</svg>`;
